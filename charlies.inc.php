...
#Fixed for php 8 by setting a constant in place of an equation thanks to JY Meuric <j-y.meuric@orange.fr>
    $fileinfo['video']['resolution_y'] = 64 ;
#      (int) (18*$conf['video_default_width']/32); #old code
  }
