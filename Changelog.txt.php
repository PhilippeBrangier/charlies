...
20221029 version 3.5 mise à jour pour php 8.x: suppression d'un calcul de résolution d'écran, remplacé par une constante (de toutes façon ne semble avoir aucun effet). Mise à jour de getid3

(pas sur que je n'ai pas oublié de mettre à jour ce fichier pour certaines versions)

20210222 version 3.2.5 identique à 3.2.4-2
